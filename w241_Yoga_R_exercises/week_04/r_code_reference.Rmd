...
# p_value <- summary(lm(outcomes ~ treatment))
# p_value$coefficients$coefficients #prints entire set of coefficients in a friendly manner that you could index later (as below)
# p_value$coefficients$coefficients[2, 4] #grab 4th element from the 2nd sub-list
