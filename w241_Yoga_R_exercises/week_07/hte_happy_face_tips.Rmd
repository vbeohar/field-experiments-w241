...
d <- read.csv("Rind_Bordia_JASP_1996.csv") #downloaded from https://yale.app.box.com/s/79v60vmb6t2hcpdhcs4bb0ylma95f8ig
...
```{r}
mod1 <- lm (tip ~ happyface + female + female * happyface, data = d)
summary(mod1)
