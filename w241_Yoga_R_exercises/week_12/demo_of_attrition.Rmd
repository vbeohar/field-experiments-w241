...
```{r}
#check the Histogram of Continuous Uniform Distribution
hist(d[, x1], freq = FALSE, xlab = 'x', density = 20)

#also check the values of the d column that we created - should be 0 and 1
hist(d[, d], freq = FALSE, xlab = 'x', density = 20)

hist(d[, missing], freq = FALSE, xlab = 'x', density = 20)
```
...
d[missing == 0, .N]
# VB - to check how many were marked as missing
d[missing == 1, .N] 
