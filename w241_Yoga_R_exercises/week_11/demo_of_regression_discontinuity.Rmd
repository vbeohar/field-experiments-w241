...
head(input_data)
#check if the mean of each column is close to 5 and 0 - which was initialized in mvrnorm()
colMeans(input_data, dims = 1)
#check if the variance of each column is close to 2 and 1 - which was initialized in vcovMatrix
colVars(input_data)
